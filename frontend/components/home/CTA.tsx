...
const CTA = () => {
  return (
    <div className='wrapper text-center space-y-8 flex flex-col items-center text-white'>
      <div className='space-y-2'>
        <h3 className='text-3xl font-bold'>Start Your Learning Journey Today!</h3>
        <p className='text-white/70'>Transform your career, gain new skills, and achieve your goals with Sea Study.</p>
      </div>
